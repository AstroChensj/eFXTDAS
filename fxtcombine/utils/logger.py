"""Logging helpers for FXT multi-epoch combination."""
...
def _default_logger() -> logging.Logger:
    """Return a process-local default stream logger for fxtcombine."""
    logger = logging.getLogger("eFXTDAS.fxtcombine.default")
    if logger.handlers:
        return logger
